...
<?php $this->block('buttons'); ?>
    <a href="javascript:;" class="btn btn-success" onclick="document.getElementById('status_form').submit();"><?= $_lang['save'] ?></a>
    <a href="<?= $this->module->makeUrl('statuses') ?>" class="btn btn-secondary"><?= $_lang['cancel'] ?></a>
<?php $this->endBlock(); ?>
